...
namespace TestUtility
{
    public abstract class AbstractCodeActionsTestFixture
    {
        ...
        private string BufferPath =>
            $"{Directory.GetCurrentDirectory()}{Path.DirectorySeparatorChar}somepath{Path.DirectorySeparatorChar}buffer{_fileTypeExtension}";

        protected AbstractCodeActionsTestFixture(
            ITestOutputHelper output,
            string fileTypeExtension = ".cs"
        )
        {
            TestOutput = output;
        ...
        protected async Task<RunCodeActionResponse> RunRefactoringAsync(
            string code,
        ...
        protected async Task<IEnumerable<OmniSharpCodeAction>> FindRefactoringsAsync(
            string code,
            IConfiguration configurationData = null
        )
        {
            ...
            {
                var requestHandler = host.GetRequestHandler<GetCodeActionsService>(
