...
namespace TestUtility
{
    public static class TestHostExtensions
    {
        ...
        public static WorkspaceInformationService GetWorkspaceInformationService(
            this OmniSharpTestHost host
        ) =>
            host.GetRequestHandler<WorkspaceInformationService>(
                OmniSharpEndpoints.WorkspaceInformation,
                "Projects"
            );
        ...
        public static async Task<OmniSharpTestHost> RestoreProject(
            this OmniSharpTestHost host,
        ...
        )
        {
            ...
            var filesChangeRequests = Directory
                .GetFiles(assetPath)
        ...
        public static async Task<MSBuildWorkspaceInfo> RequestMSBuildWorkspaceInfoAsync(
            this OmniSharpTestHost host
        )
        {
        ...
        public static async Task<QuickFixResponse> RequestCodeCheckAsync(
            this OmniSharpTestHost host,
        ...
        )
        {
            ...
            var request =
                filePath == null
                    ...
                    : new CodeCheckRequest { FileName = filePath };
