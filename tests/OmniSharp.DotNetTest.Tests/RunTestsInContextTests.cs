...
namespace OmniSharp.DotNetTest.Tests
{
    public class RunTestsInContextTests : AbstractTestFixture
    {
        ...
        protected async Task<RunTestResponse> RunDotNetTestAsync(
            ...
            string fileName = "TestProgram.cs"
        )
        {
            ...
            {
                var service = host.GetRequestHandler<RunTestsInContextService>(
                    OmniSharpEndpoints.V2.RunTestsInContext
                );
        ...
        public async Task InvokeParameterizedTest(
            int line,
            int column,
            string projectName,
        ...
        public async Task NoContainingMethodInvokesClass(
            int line,
            int column,
            string projectName,
            int expectedNumTests
