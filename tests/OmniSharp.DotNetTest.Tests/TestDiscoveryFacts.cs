...
namespace OmniSharp.DotNetTest.Tests
{
    public class TestDiscoveryFacts : AbstractTestFixture
    {
        ...
        [InlineData(
            ...
            xunit,
            XunitTestMethod,
            "Main.Test.MainTest.DataDrivenTest1"
        )]
        [InlineData(
            XunitTestProject,
            TestProgram,
            ...
            xunit,
            XunitTestMethod,
            "Main.Test.MainTest.DataDrivenTest2"
        )]
        [InlineData(
            XunitTestProject,
            TestProgram,
            ...
            xunit,
            XunitTestMethod,
            "Main.Test.MainTest.FailingTest"
        )]
        [InlineData(
            XunitTestProject,
            TestProgram,
            ...
            xunit,
            XunitTestMethod,
            "Main.Test.MainTest.CheckStandardOutput"
        )]
        ...
        [InlineData(
            ...
            nunit,
            NUnitTestMethod,
            "Main.Test.MainTest.SourceDataDrivenTest"
        )]
        [InlineData(
            NUnitTestProject,
            TestProgram,
        ...
        [InlineData(
            ...
            nunit,
            NUnitTestMethod,
            "Main.Test.GenericTest`1.TypedTest"
        )]
        public async Task FindTestMethods(
            string projectName,
            string fileName,
            int line,
            int column,
        ...
        private async Task AssertWithMemberTree(
        ...
        {
            var membersAsTreeService = host.GetRequestHandler<MembersAsTreeService>(
                OmniSharpEndpoints.MembersTree
            );

            var request = new MembersTreeRequest { FileName = filePath };
        ...
        private async Task AssertWithCodeStructure(
            OmniSharpTestHost host,
            string filePath,
            int line,
            int column,
        ...
        )
        {
            ...
            {
                if (
                    codeElement.Properties.TryGetValue("testFramework", out var testFramework)
        ...
        private static async Task<CodeElement> GetContainingCodeElementAsync(
            OmniSharpTestHost host,
            string filePath,
            int line,
            int column
        ...
        {
            var codeStructureService = host.GetRequestHandler<CodeStructureService>(
                OmniSharpEndpoints.V2.CodeStructure
            );

            var request = new CodeStructureRequest { FileName = filePath };
