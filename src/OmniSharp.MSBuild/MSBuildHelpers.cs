...
namespace OmniSharp.MSBuild
{
    internal static class MSBuildHelpers
    {
        ...
        static MSBuildHelpers()
        {
            ...
            s_BuildEnvironmentHelperType = s_MicrosoftBuildAssembly.GetType(
                "Microsoft.Build.Shared.BuildEnvironmentHelper"
            );
            s_BuildEnvironmentType = s_MicrosoftBuildAssembly.GetType(
                "Microsoft.Build.Shared.BuildEnvironment"
            );
            s_VisualStudioLocationHelperType = s_MicrosoftBuildAssembly.GetType(
        ...
        public static bool CanInitializeVisualStudioBuildEnvironment()
        {
            ...
            var initializeMethod = s_BuildEnvironmentHelperType.GetMethod(
                "Initialize",
