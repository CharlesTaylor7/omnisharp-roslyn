...
namespace OmniSharp.FileSystem
{
    ...
    public class FileSystemHelper
    {
        ...
        public IEnumerable<string> GetFiles(string includePattern) =>
            GetFiles(includePattern, _omniSharpEnvironment.TargetDirectory);
        ...
        public IEnumerable<string> GetFiles(string includePattern, string targetDirectory)
        {
            ...
            if (
                _omniSharpOptions.FileOptions.SystemExcludeSearchPatterns != null
                && _omniSharpOptions.FileOptions.SystemExcludeSearchPatterns.Any()
            )
            {
            ...
            if (
                _omniSharpOptions.FileOptions.ExcludeSearchPatterns != null
                && _omniSharpOptions.FileOptions.ExcludeSearchPatterns.Any()
            )
            {
        ...
        public static string GetRelativePath(string fullPath, string basePath)
        {
            ...
            if (!Path.IsPathRooted(basePath) || !Path.IsPathRooted(fullPath))
                return null;

            // if they are the same, abort
            if (fullPath.Equals(basePath, StringComparison.Ordinal))
                return null;
