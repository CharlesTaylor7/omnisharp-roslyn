namespace OmniSharp
{
    public static class OmniSharpEndpoints
    {
        ...
        public static class V2
        {
            ...
            public const string DebugTestsInContextGetStartInfo =
                "/v2/debugtestsincontext/getstartinfo";
            public const string DebugTestStop = "/v2/debugtest/stop";
            public const string DebugTestsInClassGetStartInfo =
                "/v2/debugtestsinclass/getstartinfo";
