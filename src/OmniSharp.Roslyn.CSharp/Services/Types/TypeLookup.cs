...
namespace OmniSharp.Roslyn.CSharp.Services.Types
{
    ...
    public class TypeLookupService : IRequestHandler<TypeLookupRequest, TypeLookupResponse>
    {
        ...
        private static readonly SymbolDisplayFormat DefaultFormat = SymbolDisplayFormat
        ...
        private static readonly SymbolDisplayFormat MinimalFormat =
        ...
        public async Task<TypeLookupResponse> Handle(TypeLookupRequest request)
        {
            ...
            if (document != null)
            {
                ...
                if (symbol != null)
                {
                    ...
                    {
                        response.Documentation = DocumentationConverter.ConvertDocumentation(
                            symbol.GetDocumentationCommentXml(),
                            _formattingOptions.NewLine
                        );
                        response.StructuredDocumentation =
                            DocumentationConverter.GetStructuredDocumentation(
                                symbol,
                                _formattingOptions.NewLine
                            );
                    }
