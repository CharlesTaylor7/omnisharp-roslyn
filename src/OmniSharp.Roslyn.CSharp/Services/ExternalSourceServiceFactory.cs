...
namespace OmniSharp.Roslyn.CSharp.Services
{
    ...
    public class ExternalSourceServiceFactory
    {
        ...
        public ExternalSourceServiceFactory(
            MetadataExternalSourceService metadataExternalSourceService,
            DecompilationExternalSourceService decompilationExternalSourceService
        )
        {
        ...
        public IExternalSourceService Create(OmniSharpOptions omniSharpOptions) =>
            omniSharpOptions.RoslynExtensionsOptions.EnableDecompilationSupport
                ? (IExternalSourceService)_decompilationExternalSourceService
        ...
        {
            var enableDecompilationSupport = omniSharpOptions
            ...
            var cancellationTimeout = enableDecompilationSupport
                ? timeout <= 10000
                    ? 10000
                    : timeout // minimum 10s for decompilation
