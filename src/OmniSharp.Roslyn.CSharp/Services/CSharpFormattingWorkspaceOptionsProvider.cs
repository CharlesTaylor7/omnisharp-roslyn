...
namespace OmniSharp.Roslyn.CSharp.Services
{
    ...
    public class CSharpFormattingWorkspaceOptionsProvider : IWorkspaceOptionsProvider
    {
        ...
        )
        {
            return optionSet
                .WithChangedOption(
                    RoslynFormattingOptions.NewLine,
                ...
                .WithChangedOption(
                    ...
                    FormattingWorker.BinaryOperatorSpacingOptionForStringValue(
                ...
                .WithChangedOption(
                    ...
                    FormattingWorker.LabelPositionOptionForStringValue(
