...
namespace OmniSharp.Extensions
{
    public static class TextExtensions
    {
        ...
        public static Point GetPointFromPosition(this SourceText text, int position)
        {
            ...
            return new Point { Line = line.LineNumber, Column = position - line.Start };
        }

        /// <summary>
        /// Converts a line number and offset to a zero-based position within a <see cref="SourceText"/>.
        /// </summary>
        public static int GetPositionFromLineAndOffset(
        ...
        public static Models.V2.Location GetLocationFromFileLinePositionSpan(
            this FileLinePositionSpan linePositionSpan
        ) =>
            new()
            {
                ...
                Range = new()
                {
                    Start = new Point
                    {
                        Line = linePositionSpan.StartLinePosition.Line,
                        Column = linePositionSpan.StartLinePosition.Character,
                    },
                    End = new Point
                    {
                        Line = linePositionSpan.EndLinePosition.Line,
                        Column = linePositionSpan.EndLinePosition.Character,
                    },
                },
            };
        ...
        /// Converts an OmniSharp <see cref="Range"/> to a <see cref="TextSpan"/> within a <see cref="SourceText"/>.
        /// </summary>
        public static TextSpan GetSpanFromLinePositionSpanTextChange(
            this SourceText text,
            LinePositionSpanTextChange change
        ) =>
            TextSpan.FromBounds(
