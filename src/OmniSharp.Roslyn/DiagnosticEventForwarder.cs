...
namespace OmniSharp.Roslyn
{
    ...
    public class DiagnosticEventForwarder
    {
        ...
        public void BackgroundDiagnosticsStatus(
        ...
        )
        {
            ...
            _emitter.Emit(
                EventTypes.BackgroundDiagnosticStatus,
                new BackgroundDiagnosticStatusMessage
                {
                    Status = status,
            ...
            _emitter.Emit(
                EventTypes.ProjectDiagnosticStatus,
                new ProjectDiagnosticStatusMessage
                {
