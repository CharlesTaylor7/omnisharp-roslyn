...
namespace OmniSharp.Helpers
{
    ...
    {
        private static ImmutableDictionary<string, ReportDiagnostic> defaultSuppressedDiagnostics =
        ...
        public static ImmutableDictionary<
            string,
            ReportDiagnostic
        > GetDefaultSuppressedDiagnosticOptions()
        {
        ...
        public static ImmutableDictionary<
            string,
            ReportDiagnostic
        > GetDefaultSuppressedDiagnosticOptions(IEnumerable<string> suppressedDiagnosticIds)
        {
            if (suppressedDiagnosticIds == null || !suppressedDiagnosticIds.Any())
                return GetDefaultSuppressedDiagnosticOptions();
        ...
        public static ImmutableDictionary<
            ...
            ReportDiagnostic
        > GetDefaultSuppressedDiagnosticOptions(
            Dictionary<string, ReportDiagnostic> otherDiagnostics
        )
        {
            if (otherDiagnostics == null || !otherDiagnostics.Any())
                return GetDefaultSuppressedDiagnosticOptions();
