...
namespace OmniSharp.LanguageServerProtocol.Handlers
{
    internal sealed class OmniSharpImplementationHandler : ImplementationHandlerBase
    {
        ...
        private readonly Mef.IRequestHandler<
            FindImplementationsRequest,
            QuickFixResponse
        > _findImplementationsHandler;
        private readonly TextDocumentSelector _documentSelector;

        public OmniSharpImplementationHandler(
            Mef.IRequestHandler<
                FindImplementationsRequest,
                QuickFixResponse
        ...
        )
        {
            ...
            return omnisharpResponse
                    ?.QuickFixes?.Select(x => new LocationOrLocationLink(
                        new Location
                        {
        ...
        {
            return new ImplementationRegistrationOptions() { DocumentSelector = _documentSelector };
        }
    }
}
