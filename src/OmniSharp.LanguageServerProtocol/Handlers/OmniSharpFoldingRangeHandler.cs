...
namespace OmniSharp.LanguageServerProtocol.Handlers
{
    class OmniSharpFoldingRangenHandler : FoldingRangeHandlerBase
    {
        ...
        public OmniSharpFoldingRangenHandler(
            Mef.IRequestHandler<BlockStructureRequest, BlockStructureResponse> definitionHandler,
        ...
        )
        {
            ...
            return new Container<FoldingRange>(
                omnisharpResponse.Spans.Select(block => new FoldingRange()
                {
        ...
        {
            return new FoldingRangeRegistrationOptions() { DocumentSelector = _documentSelector };
        }
    }
}
