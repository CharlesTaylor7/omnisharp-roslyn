...
namespace OmniSharp.LanguageServerProtocol.Handlers
{
    internal class OmniSharpSemanticTokensHandler : SemanticTokensHandlerBase
    {
        ...
        internal static readonly ImmutableDictionary<
            ...
            SemanticTokenType
        > _coreTokenMap = new Dictionary<SemanticHighlightClassification, SemanticTokenType>()
        {
        ...
        public OmniSharpSemanticTokensHandler(
            Mef.IRequestHandler<
                SemanticHighlightRequest,
                SemanticHighlightResponse
            > definitionHandler,
        ...
        )
        {
            ...
            foreach (var span in omnisharpResponse.Spans)
            {
                ...
                builder.Push(
                    range,
                    _tokenTypes[span.Type],
                    span.Modifiers.Select(modifier => _tokenModifiers[modifier])
                );
            }
        }
